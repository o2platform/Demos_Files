<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
	CodeBehind="ApplyForAccount.aspx.cs" Inherits="SuperSecureBank.ApplyForAccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<h1>
		...
		Open a new account</h1>
	<asp:Label ID="message" runat="server" />
	<p>
		Thank you for applying for a new account! Please use the form below to apply, your
		case will be reviewed and if accepted you will see it in your account list.</p>
	...
	<asp:HiddenField ID="StartingBalance" runat="server" Value="0" />
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ssbcon %>"
		SelectCommand="SELECT * FROM [AccountTypes] WHERE IsLoan = 0"></asp:SqlDataSource>
</asp:Content>
